...
import Button from "../components/Button";
  ...
  const student = [
      {
          school_id: "123SHANTH228",
            ...
            blood_group: "A+",
            pic: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80",
            gender: "Male",
      },
    ]
  ...
  const timetable = {
    "Monday": {
      ...
      "10:00 AM - 11:00 AM": "Maths",
      "11:00 AM - 12:00 PM": "Science",
      "12:00 PM - 01:00 PM": "Lunch",
      "01:00 PM - 02:00 PM": "Social",
      "02:00 PM - 03:00 PM": "Telugu",
      "03:00 PM - 04:00 PM": "Hindi"
    },
    "Tuesday": {
      "09:00 AM - 10:00 AM": "Social",
      "10:00 AM - 11:00 AM": "Maths",
      "11:00 AM - 12:00 PM": "Science",
      "12:00 PM - 01:00 PM": "Lunch",
      "01:00 PM - 02:00 PM": "Telugu",
      "02:00 PM - 03:00 PM": "Hindi",
      "03:00 PM - 04:00 PM": "English"
    },
    "Wednesday": {
      "09:00 AM - 10:00 AM": "Telugu",
      "10:00 AM - 11:00 AM": "English",
      "11:00 AM - 12:00 PM": "PE",
      "12:00 PM - 01:00 PM": "Lunch",
      "01:00 PM - 02:00 PM": "Social",
      "02:00 PM - 03:00 PM": "Maths",
      "03:00 PM - 04:00 PM": "Hindi"
    },
    "Thursday": {
      "09:00 AM - 10:00 AM": "Social",
      "10:00 AM - 11:00 AM": "English",
      "11:00 AM - 12:00 PM": "Hindi",
      "12:00 PM - 01:00 PM": "Lunch",
      "01:00 PM - 02:00 PM": "Maths",
      "02:00 PM - 03:00 PM": "Telugu",
      "03:00 PM - 04:00 PM": "Science"
    },
    "Friday": {
      "09:00 AM - 10:00 AM": "Maths",
      "10:00 AM - 11:00 AM": "Science",
      "11:00 AM - 12:00 PM": "English",
      "12:00 PM - 01:00 PM": "Lunch",
      "01:00 PM - 02:00 PM": "Reading",
      "02:00 PM - 03:00 PM": "Telugu",
      "03:00 PM - 04:00 PM": "Hindi"
    },
    "Saturday": {
      ...
      "11:00 AM - 12:00 PM": "English",
      "12:00 PM - 01:00 PM": "Lunch",
      "01:00 PM - 02:00 PM": "PE",
      "02:00 PM - 03:00 PM": "PE",
      "03:00 PM - 04:00 PM": "PE"
    }
  };
    ...
    <div className="px-4 sm:px-2 lg:px-4 max-w-full">
      <div className="sm:flex sm:items-center">
        ...
        <p className="text-sm text-gray-500 sm:text-md md:max-w-3xl">
            Individual student information, Time Table, Attendance, Exam Marks, Fee Payments
        </p>
        </div>
      ...
      <div className="max-w-7xl bg-white shadow-md md:px-6 px-2 md:py-3 py-2 md:rounded-2xl rounded-md border border-slate-200">
        <h2 className="text-slate-500 text-xl py-2 font-bold">Student Information</h2>
        <ul
          role="list"
        ...
        <div className="max-w-7xl bg-white shadow-md md:px-6 px-2 md:py-3 py-2 md:rounded-2xl rounded-md border border-slate-200">
        {/* <h2 className="text-slate-500 text-xl py-2 font-bold">Student Attendance <small className="text-xs text-slate-400 ">(in %)</small></h2> */}
        <div className="flex flex-col">

          <h2 className="text-xl sm:text-2xl text-slate-600">Total Attendance % till date - <span className="font-bold rounded-md bg-indigo-100 text-indigo-700 py-1">  &nbsp;92%&nbsp;  </span></h2>
        </div>
      </div>
       ...
       {/*Student Time Table  */}
      <div className="max-w-7xl bg-white shadow-md md:px-6 px-2 md:py-3 py-2 md:rounded-2xl rounded-md border border-slate-200">
        <h2 className="text-slate-500 text-xl py-2 font-bold">Class Time Table <small className="text-xs text-slate-400 ">(Class X)</small></h2>
        <div className="flex flex-col">
      ...
      {/*Student Exams Marks  */}
      <div className="max-w-7xl bg-white shadow-md md:px-6 px-2 md:py-3 py-2 md:rounded-2xl rounded-md border border-slate-200">
        <h2 className="text-slate-500 text-xl py-2 font-bold">Exam Marks</h2>
        <div className="flex flex-col">
          <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
              <div className="shadow overflow-hidden border border-gray-200 sm:rounded-lg">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        <tr className="divide-x divide-gray-200">
                          ...
                          <td className="px-4 py-2 whitespace-nowrap text-sm text-slate-700">
                          <a onClick={() => setOpenExamMarks(true)} className="underline text-blue-600 cursor-pointer">Edit</a>
                          </td>
                        </tr>
                        <tr className="divide-x divide-gray-200">
                          <td className="px-4 py-2 whitespace-nowrap text-sm font-bold text-slate-700">
                          ...
                          <td className="px-4 py-2 whitespace-nowrap text-sm text-slate-700">
                          <a className="underline text-blue-600 cursor-pointer">Edit</a>
                          </td>
                        </tr>
                        <tr className="divide-x divide-gray-200">
                          <td className="px-4 py-2 whitespace-nowrap text-sm font-bold text-slate-700">
      ...
      {/*Student Fee Payment  */}
      <div className="max-w-7xl bg-white shadow-md md:px-6 px-2 md:py-3 py-2 md:rounded-2xl rounded-md border border-slate-200">
        <h2 className="text-slate-500 text-xl py-2 font-bold">Fee Payment</h2>
        <div className="flex flex-col">
          <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
              <div className="shadow overflow-hidden border border-gray-200 sm:rounded-lg">
