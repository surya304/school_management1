    ...
    <>
     <ToastContainer autoClose={3000} />
      ...
      <div className="m-auto px-8 py-6">
          ...
          <div className="sm:max-w-5xl max-w-full mt-4 grid grid-cols-2 sm:grid-cols-2 gap-3 justify-start w-full justify-start items-center">
            <div className="flex space-x-4 max-w-3xl">
              ...
              <button
                ...
                type="button"
                className="mt-5 rounded bg-indigo-600 py-1 px-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Upload CSV File
              </button>
            </div>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {timetableData.map((item) => (
                    <tr key={item._id}>
                      ...
                      <p>{item.daytype}</p>
                        <span onClick={() => openpopdata(item)} className="w-14 inline-flex items-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-xs font-medium text-indigo-700">
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="max-w-full overflow-auto px-0 py-2 flex space-x-3">
                            ...
                            <ul role="list" className=" flex space-x-1">
                              {item.value.map((item1, index) => (
                                ...
                                >
                                  ...
                                  {item1.type == "break" && (
                                    <div className="border border-gray-200 rounded-lg w-24 h-24 pt-1 bg-gray-300 rounded-lg relative ml-2" >
                                      <div className="flex flex-1 flex-col px-0 py-0 mb-1">
                                        <div>
                                          <div className="flex justify-around pt-2 px-2">
                                            <div className="timepicker relative form-floating text-left">
                                              {/* <input
                                                type="text"
                                                className="w-10 px-1 py-1 text-base font-thin sm:text-xs text-slate-600 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                ...
                                                disabled
                                              /> */}
                                              <small className="text-xs text-gray-700 font-thin border border-gray-200 p-1 rounded-md">{item1.from_time}</small>
                                            </div>
                                            ...
                                            <div className="timepicker relative form-floating text-left">
                                              ...
                                              <small className="text-xs text-gray-700 font-thin border border-gray-200 p-1 rounded-md">{item1.to_time}</small>
                                            </div>
                                          </div>
                                        </div>
                          ...
                          <span className="grid grid-cols-1 bg-white border-2 border-slate-200 hover:border-slate-300 rounded-lg w-24 h-24 py-1 px-2 gap-2 items-center justify-center">
                            <button
                              className="sm:text-xs inline-flex items-center mx-auto rounded-md border border-transparent bg-indigo-100 px-2 py-1 font-medium text-indigo-700 shadow-sm hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                              onClick={() =>
                            ...
                            <button
                              className="sm:text-xs inline-flex items-center mx-auto rounded-md border border-transparent bg-gray-300 px-2 py-1 font-medium text-gray-800 shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      ...
      <div id="myModal21" className="modal21" style={{ display: "none" }}>
        <div className="modal-content21">
                                  ...
                                  {detail.type == "period" && (
                                    <div>
                                      <h3 className="mt-2 text-sm font-medium text-gray-900 truncate ">
                                        Subject : {detail.subject_id.name}
                                      </h3>
                                      <h3 className="mt-2 text-sm font-medium text-gray-900 truncate ">
                                        From Time : {detail.from_time}
                                      </h3>
                                      <h3 className="mt-2 text-sm font-medium text-gray-900 truncate ">
                                        To time :{detail.to_time}
                                      </h3>

                                      <h3 className="text-sm text-gray-500 truncate ">
                                        Teacher Name :{" "}
                                        {detail.teacher_id.first_name}{" "}
                                        {detail.teacher_id.last_name}
                                      </h3>
                                    </div>
                                  )}
          ...
          <div className="mt-5 sm:mt-6 mx-auto max-w-2xl text-center">
            <button
              type="button"
                        ...
                        <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div>
                            <label className="block text-sm font-medium text-gray-700">
                              break_name Ex : lunch break , snacks , morning
                              break
                            </label>
                            <div className="mt-1">
                              <input
